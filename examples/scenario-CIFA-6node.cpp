...
/*   consumerHelper.SetAttribute("NumberOfContents", StringValue(g_CP.getContents()));
  ...
  // string rateTracerDir = "/usr/local/src/trace/rate-trace-normal-chinanet-N-" + fre + ".txt";
  // string pitTracerDir = "/usr/local/src/trace/pit-trace-normal-chinanet-N-" + fre + ".txt";
