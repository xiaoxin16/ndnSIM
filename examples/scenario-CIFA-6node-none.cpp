...
main(int argc, char* argv[])
{
  ...
  string fre = "400";//g_CP.getFrequency();
  ...
  consumerHelper.SetAttribute("Randomize", StringValue("none")); //none  uniform
/*   consumerHelper.SetAttribute("NumberOfContents", StringValue(g_CP.getContents()));
  ...
  ostringstream os2;
  os2 << attackPeriod;
  string rateTracerDir = "/usr/local/src/trace/rate-trace-CIFA-" + attackFreq + "-T-" + os2.str() + ".txt";
  string pitTracerDir = "/usr/local/src/trace/pit-trace-CIFA-" + attackFreq + "-T-" + os2.str() + ".txt";
  
  //string rateTracerDir = "/usr/local/src/trace/rate-trace-normal-400-none.txt";
  //string pitTracerDir = "/usr/local/src/trace/pit-trace-normal-400-none.txt";
