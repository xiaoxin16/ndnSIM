...
main(int argc, char* argv[])
{
  ...
  ndn::L3RateTracer::InstallAll("/usr/local/src/trace/rate-trace-normal.txt", Seconds(0.2));
  ...
  ndn::PitTracer::InstallAll("/usr/local/src/trace/pit-trace-normal.txt", Seconds(0.2));
